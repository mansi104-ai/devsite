---
title: "Fine-Tuning an RNN Model Built From Scratch — Fully Customizable Sequence Learning"
publishedAt: "2025-02-12"
summary: "After understanding CNNs vs RNNs, this guide walks you through using and customizing a pure NumPy RNN implementation—from forward pass to BPTT, activations, sequence modeling, and fine-tuning."
---
...
If you haven’t read it yet, it sets the perfect conceptual foundation:
...
This is not a framework-dependent model — **you own every parameter**.  
Perfect for learning, research, experimentation, and portfolio work.

Repo link:  
👉 **https://github.com/mansi104-ai/100_days_ml_code/tree/main/RNNs**
...
Each file controls **one responsibility**—just like a real deep learning framework.

Let’s walk through how you can fine-tune each part.
...
- **tanh** → classic RNN behavior  
- **swish** → smoother gradient flow  
- **ReLU-like activations** → high-variance signals  
- **Custom gate functions** → build GRUs/LSTMs manually  
...
🧠 CNNs vs RNNs — Understanding Architecture Choice https://mansikalra.vercel.app/blogs/cnns_vs_rnns
...
Whether you want to experiment with activation functions, new gating mechanisms, different losses, or your own datasets — this NumPy RNN gives you a complete foundation to explore sequence models deeply.
Happy Experimenting! 🚀