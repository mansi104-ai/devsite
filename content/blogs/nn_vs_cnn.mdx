...
**1. Capturing Local Patterns**: In general, having more trainable parameters suggests that a model might perform better. However, in this case, the CNN achieves higher accuracy despite having fewer trainable parameters than the basic neural network. 
...
**2. Parameter Efficiency** :For example, if you're working on an image dataset to build a classifier for apples and mangoes, a neural network tends to learn the patterns in the images—the more, 
...
**3. Translation Invariance** :When you close one of your eye, you see the window in front of you slightly shifted.
