...
const cookingItems = [
  {
    ...
    title: "Vermicilli",
    category: "mains",
    tags: ["#FillingMeal", "#Fermented", "#WeekendProject"],
    image: "/images/cooking/vermicilli.jpg",
    description: "Delicately thin vermicelli strands with a silky, light texture. Crafted through a slow-drying process for maximum flavor and perfect bite",
    cookTime: "60 mins",
    difficulty: "Basic",
    servings: "4-5",
  },
  {
    id: 2,
    title: "Cherry-Vanilla Cupcake",
    category: "dessert",
    tags: ["#Delicacy", "#Single-serve", "#BakedWithLove"],
    image: "/images/cooking/cupcake.jpg",
    description: "A fluffy vanilla cupcake crowned with a swirl of cherry-infused frosting, topped with a juicy sweet cherry. Moist, airy crumb balanced with a burst of fruity brightness.",
    cookTime: "30 mins",
    difficulty: "Medium",
    servings: "1",
  },
  {
    id: 3,
    title: "Potato Noodles",
    category: "appetizers",
    tags: ["#ChewyDelight", "#PotatoNoodles", "#ComfortInABowl"],
    image: "/images/cooking/potato_noodles.jpg",
    description: "Springy potato noodles with a smooth, chewy bite. Made from fresh potatoes and crafted through slow kneading for a naturally earthy flavor and satisfying texture.",
    cookTime: "25 min",
    difficulty: "Medium",
    servings: "2",
  },
  {
    ...
    category: "appetizers",
    tags: ["#TropicalBite", "#Cafe&Pineapple", "#SweetAndSavory"],
    image: "/images/cooking/PineToast.jpg",
    description: "Golden pineapple slices layered between soft, buttery bread with a hint of sweetness. A refreshing tropical twist that’s light, juicy, and irresistibly flavorful.",
    cookTime: "15 min",
    difficulty: "Easy",
    servings: "1",
  },
